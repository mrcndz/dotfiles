...
local mappings = {
    ...
    ["m"] = {"<cmd>Telescope bookmarks list theme=dropdown<cr>", "Bookmarks" },
    ...
    l = {
        ...
        s = { "<cmd>Telescope lsp_document_symbols theme=cursor<cr>", "Document Symbols" },
        S = { "<cmd>Telescope lsp_workspace_symbols theme=cursor<cr>", "Workspace Symbols" },
