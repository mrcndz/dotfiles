...
nnoremap <silent> s :call VSCodeNotify('editor.action.addSelectionToNextFindMatch')<CR>
xnoremap <silent> s :call VSCodeNotify('editor.action.addSelectionToNextFindMatch')<CR>
]]
